...
import { Home, Sliders, X } from 'lucide-react';
...
const [selectedRoutes, setSelectedRoutes] = useState<string[]>([]);
  const [routePanels, setRoutePanels] = useState<Record<string, RoutePanelLayout>>({});
